...
DATA_TYPE_DIMS = {GLOBALS: 82, LEVELS: 4, LAYERS: 48, OUTPUTS_CLEARSKY: 1, OUTPUTS_PRISTINE: 1}

TRAIN_YEARS = list(range(1979, 1991)) + list(range(1994, 2005))
VAL_YEARS = [2005, 2006]
#TEST_YEARS = list(range(2007, 2015))
TEST_YEARS = [2014]
OOD_PRESENT_YEARS = [2014]
#OOD_PRESENT_YEARS = None
OOD_FUTURE_YEARS = None
OOD_HISTORIC_YEARS = None
